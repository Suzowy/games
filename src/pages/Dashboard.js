    ...
    const juegos = [
      {
        ...
        descripcion: (
          <>
            Los jugadores se turnan para colocar sus fichas en el tablero con el objetivo de obtener tres de sus fichas en línea horizontal, vertical o diagonal antes que el oponente.
            <br />
            <img
      ...
      },
      {
        ...
        descripcion: (
          <>
          Es un apasionante juego de lógica y números que desafía tu capacidad para llenar un tablero 9x9 con dígitos del 1 al 9 sin repetir ningún número en filas, columnas o regiones.
          <img
      ...
      },
      {
        ...
        descripcion: (
          <>
            Es un intrigante juego de adivinanzas en el que los jugadores deben hacer preguntas de sí o no para descubrir el personaje secreto del oponente.
            <br />
            <img
      ...
      },
      {
        ...
        descripcion: (
          <>
           Pon a prueba tu capacidad de recordar la ubicación de las cartas y emparejarlas antes de que se acabe el tiempo.
            <br />
            <img
      ...
      },
      {
        ...
        descripcion: (
          <>
          Es un juego de velocidad y reflejos donde debes atrapar a un topo que aparece y desaparece en agujeros.
            <br />
            <img
